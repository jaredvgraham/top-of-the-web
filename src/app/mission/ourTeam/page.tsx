        ...
        <div className={`flex w-full justify-center items-center `}>
          ...
          >
            ...
            <motion.p
              ...
              variants={itemVariants}
            >
              Jared Graham is a talented full stack developer and designer with
              a keen eye for aesthetics and user experience. Specializing in
              creating visually appealing and highly functional interfaces,
              Jared combines his expertise in design with cutting-edge
